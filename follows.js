(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'CFlYlAkesR2oC6bcqL5U30gw4Y5zZkl5uFFFbswKSlIQ6M0W', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1122287245], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Casco', // Replaces Xively logo in the header
		dataDuration	= '90 días', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 10800, // Default interval for data to be displayed (in seconds)
		dataColor		= '0A1922', // CSS HEX value of color to represent data (omit leading #)
